...
function SidebarTrigger({
    ...
    return (
        <Button
            ...
            variant="ghost"
            size="icon"
            className={cn(`w-full ${!open ? "" : "justify-start pl-4"} hover:bg-sidebar-accent dark:hover:bg-sidebar-accent  dark:hover:text-black `, className)}
            onClick={(event) => {
                onClick?.(event);
                toggleSidebar();
            }}
            ...
            {open ? (
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                         <span> <ArrowRightCircle className="w-10 h-10" /></span>
                    </TooltipTrigger>
